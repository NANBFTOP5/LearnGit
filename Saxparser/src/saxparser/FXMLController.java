...
public class FXMLController implements Initializable {
    ...
    // Below is modified from ClassroomUIController class example
    @FXML
    ...
    private void displayAboutAlert() {
        ...
        alert.setContentText("This application was developed by Hunter Ginther for CS4330 at the University of Missouri. "
                + "This uses a given class example as inspiration for a starting point, which was created by Dale Musser");

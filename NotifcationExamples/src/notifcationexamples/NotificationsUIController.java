...
public class NotificationsUIController implements Initializable, Notifiable {
    ...
    public void startTask1(ActionEvent event) {
        ...
        if (task1 == null) {
            ...
            task1.start();
            FirstButton.setText("End Task1");
        }else{
            task1.end();
            System.out.println("end task 1");
            task1 = null;
            
            FirstButton.setText("Start Task1");
        }
    }
    ...
    public void startTask2(ActionEvent event) {
        ...
        if (task2 == null) {
            ...
            task2.start();
            SecondButton.setText("End Task2");
        }else{
            ...
            SecondButton.setText("Start Task2");
    ...
    public void startTask3(ActionEvent event) {
        ...
        if (task3 == null) {
            ...
            task3.start();
            ThirdButton.setText("End Task3");
        }else{
            task3.end();
            System.out.println("end task 3");
            task3 = null;
            
            ThirdButton.setText("Start Task3");
        }
    } 
}

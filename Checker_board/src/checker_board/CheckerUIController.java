 ...
 * @author hwwq4
 */
public class CheckerUIController implements Initializable {
    ...
    private Checker_board checkerBoard;
    ...
    private void renderBoard(){
        ...
        checkerBoard = new Checker_board(numRows, numCols, boardWidth, boardHeight, lightColor, darkColor);

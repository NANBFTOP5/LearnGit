...
public class Checker_board {
    ...
    public Checker_board(int numRows, int numCols, double boardWidth, double boardHeight) {
    ...
    public Checker_board(int numRows, int numCols, double boardWidth, double boardHeight, Color lightColor, Color darkColor) {
